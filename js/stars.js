...
window.StarChart = (function () {
  ...
  var LINE_FORK_CHANCE = 0.35 // .25 = 25% chance
  var LINE_WIDTH = 1
  var HOPS = 10
  ...
  var STAR_LARGE_CHANCE = 0.1 // .1 = 10% chance
...
var starchart = new window.StarChart(document.getElementById('stars'), pixi, 70, 70, 2)
starchart.run()
